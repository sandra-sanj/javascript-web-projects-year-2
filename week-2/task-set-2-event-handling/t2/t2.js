...
const renderModalContent = (restaurant) => {
  ...
  document.getElementById('restaurant-postal-code').innerText =
    restaurant.postalCode;
  document.getElementById('restaurant-city').innerText = restaurant.city;
  document.getElementById('restaurant-phone').innerText = restaurant.phone;
  document.getElementById('restaurant-company').innerText = restaurant.company;
};
